...
df_buffers <-readRDS("./data/df_buffers_test.rds")
proj_buffers <- readRDS("./data/proj_buffers_test.rds")
```
...
```{r}
  ...
  # Schools
    ...
    addMarkers(data=df_buffers, ~longitud, ~latitud,group = "Schools",
                ...
                iconUrl = './data/school_icon.png',
                 iconSize = c(75, 75))) %>% 
  # convexhulls
  addPolygons(data=hulls_sf$polygons, group = "Convex Hulls",
  ...
  # Additionals
    ...
    overlayGroups = c("Schools", "Buffers", "Convex Hulls"),
